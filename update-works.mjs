...
const worksData = [
  ...
  },
  {
    ...
    title: "文以載道但載不動我模擬器",
    author: "第十六組",
    description: "以靜宜大學為地理藍本，將中國文學系的學科與校園生活轉化為具象的遊戲機制，讓玩家跑過一圈如同度過一年，深度體驗一名中文系學生完整的大學四年生活。"
  },
  {
    workNumber: 17,
    title: "靜物微縮劇場！讓「思無邪」的婚戀穿越藩籬",
    author: "第十七組",
    description: "選定四首《詩經》春季婚戀詩，分別為〈子衿〉、〈野有蔓草〉、〈關雎〉、〈桃夭〉。以微縮模型嘗試「穿越藩籬」，也可以理解為讓「物件說話」的一座「劇場」。"
  }
];
